...
## Step 1: Web Scraping
I used beautifulsoup to scrape the text of each rally. I recognise that I could have used R to do it, but I decided to use Python and beautifulsoup as I am more familiar with Python. For more details, please look through NDR_webscraping.

## Step 2: Text Processing
Following this tutorial (https://programminghistorian.org/en/lessons/basic-text-processing-in-r), I then performed text analysis on the corpus of rallies. This included plotting the change in word count and median sentence length over the years, as well as the most commonly used words in each rally. For more details, please look through NDR_stylometric_analysis.
